...
unrealRootPath=/home/cephalgia/Tools/UnrealEngine-release
QuestRoomRootPath=/home/cephalgia/UnrealProjects/QuestRoom 4.17

gameProjectFile=/home/cephalgia/UnrealProjects/QuestRoom 4.17/QuestRoom.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(QuestRoomSource.pri)
include(QuestRoomHeader.pri)
include(QuestRoomConfig.pri)
include(QuestRoomIncludes.pri)
include(QuestRoomDefines.pri)
...
QuestRoom-Linux-Debug.commands = $$build QuestRoom Linux Debug  -project="\"$$gameProjectFile\"" $$args
QuestRoom-Linux-DebugGame.commands = $$build QuestRoom Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
QuestRoom-Linux-Shipping.commands = $$build QuestRoom Linux Shipping  -project="\"$$gameProjectFile\"" $$args
QuestRoom-Linux-Test.commands = $$build QuestRoom Linux Test  -project="\"$$gameProjectFile\"" $$args
QuestRoom.commands = $$build QuestRoom Linux Development  -project="\"$$gameProjectFile\"" $$args

QuestRoomEditor-Linux-Debug.commands = $$build QuestRoomEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
QuestRoomEditor-Linux-DebugGame.commands = $$build QuestRoomEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
QuestRoomEditor-Linux-Shipping.commands = $$build QuestRoomEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
QuestRoomEditor-Linux-Test.commands = $$build QuestRoomEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
QuestRoomEditor.commands = $$build QuestRoomEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	QuestRoom-Linux-Debug \
	QuestRoom-Linux-DebugGame \
	QuestRoom-Linux-Shipping \
	QuestRoom-Linux-Test \
	QuestRoom \
	QuestRoomEditor-Linux-Debug \
	QuestRoomEditor-Linux-DebugGame \
	QuestRoomEditor-Linux-Shipping \
	QuestRoomEditor-Linux-Test \
	QuestRoomEditor \
