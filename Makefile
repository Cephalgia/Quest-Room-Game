...
QuestRoom-Linux-Debug:
	 $(PROJECTBUILD) QuestRoom Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

QuestRoom-Linux-DebugGame:
	 $(PROJECTBUILD) QuestRoom Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

QuestRoom-Linux-Shipping:
	 $(PROJECTBUILD) QuestRoom Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

QuestRoom-Linux-Test:
	 $(PROJECTBUILD) QuestRoom Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

QuestRoom:
	 $(PROJECTBUILD) QuestRoom Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

QuestRoomEditor-Linux-Debug:
	 $(PROJECTBUILD) QuestRoomEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

QuestRoomEditor-Linux-DebugGame:
	 $(PROJECTBUILD) QuestRoomEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

QuestRoomEditor-Linux-Shipping:
	 $(PROJECTBUILD) QuestRoomEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

QuestRoomEditor-Linux-Test:
	 $(PROJECTBUILD) QuestRoomEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

QuestRoomEditor:
	 $(PROJECTBUILD) QuestRoomEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
